...
| Frontend | Vitest (proyectos Vite) / Jest + RTL (Next.js) | Un test trivial de que la app renderiza sin errores — `ranger` se encarga de la estrategia completa después |
