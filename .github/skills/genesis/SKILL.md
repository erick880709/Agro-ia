...
```
janus / epicureo / specter → archi (Caso A) → genesis → builder (primera HU real) → ranger
                                                  ↑
...
- `resources/design/data-model.md` — normalmente sin entidades todavía (estructura lista para
  ...
  relaciones concretos (porque `archi` los tomó de un desglose de `specter` ya resuelto — ver
