"""AgroIA RAG Agent Service — Agente conversacional con RAG + GPT-4."""
...
async def lifespan(app: FastAPI):
    logger.info("rag_starting")
    yield
    logger.info("rag_stopping")

app = FastAPI(title="AgroIA RAG Agent", version="0.1.0", lifespan=lifespan)
