...
async def process_sensor_message(message: dict) -> bool:
    ...
    try:
        ...
        reading = SensorReading(
            ...
            ts=ts,
            sensor_id=device_id,
            pos_x=_a_flotante(message.get("latitude", message.get("pos_x", raw.get("latitude", raw.get("pos_x"))))),
            pos_y=_a_flotante(message.get("longitude", message.get("pos_y", raw.get("longitude", raw.get("pos_y"))))),
            ph=payload.get("ph"),
